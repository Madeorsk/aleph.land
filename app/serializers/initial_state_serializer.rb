  ...
  def default_meta_store
    {
      ...
      liberapay_url: Rails.configuration.x.liberapay_url,
      liberapay_donations_goal: Rails.configuration.x.liberapay_donations_goal,
      liberapay_donations_status: Rails.configuration.x.liberapay_donations_status,
