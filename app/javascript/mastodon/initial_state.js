...
export const liberapayDonationsGoal = Number.parseFloat(getMeta('liberapay_donations_goal') ?? "0") ?? 0;
export const liberapayDonationsStatus = Number.parseFloat(getMeta('liberapay_donations_status') ?? "0") ?? 0;
